...
use app\modules\pendaftaran\models\PasienSearch;
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Pasien",
                    'content'=>'<span class="text-success">Create Pasien success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
